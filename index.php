	...
	<!-- 						<div class="testimonial__info">
			...
			<section class="section-wrap blog-grid call-center">
				<div class="container">
						...
						<div class="col-lg-4">
							<div class="blog-grid__title-col d-flex flex-column mb-lg-48">
								...
								<div class="title-row">
									...
									<a class="b24-web-form-popup-btn-24 call-back mt-auto">
										<img src="../img/new/now.png" alt=""><span class="call-us__title">
					...
					<div class="container aboutcopy" style="padding: 0;">
						<div class="row">
							<div class="col-lg-12">
									...
									<p>
										...
										<img class="about_img lazyload" data-src="img/main.jpg" alt="Kazpromothod">
									<p>
...
<noscript><div><img src="https://mc.yandex.ru/watch/67086451" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-104698403-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-104698403-1');
</script>
